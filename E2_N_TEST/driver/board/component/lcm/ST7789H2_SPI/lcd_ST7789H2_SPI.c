...
#define LCD_A0 HAL_GPIO_20
#define LCD_CS HAL_GPIO_19
#define LCD_RESET HAL_GPIO_23
...
void LCD_blockClear_ST7789H2(uint16_t x1,uint16_t y1,uint16_t x2,uint16_t y2,uint16_t data)
{
    ...
    LCD_DataWrite_ST7789H2(((y1+80)&0xFF00)>>8);
    LCD_DataWrite_ST7789H2((y1+80)&0xFF);
    LCD_DataWrite_ST7789H2(((y2+80)&0xFF00)>>8);
    LCD_DataWrite_ST7789H2((y2+80)&0xFF);
#else
	LCD_CtrlWrite_ST7789H2(0x2B);
...
//	hal_display_lcd_toggle_reset(10, 120);
	...
	LCD_DataWrite_ST7789H2( 0x2b);
	LCD_DataWrite_ST7789H2( 0x08);
	LCD_DataWrite_ST7789H2( 0x07);
	LCD_DataWrite_ST7789H2( 0x14);
	LCD_DataWrite_ST7789H2( 0x44);
	LCD_DataWrite_ST7789H2( 0x55);
	LCD_DataWrite_ST7789H2( 0x55);
	LCD_DataWrite_ST7789H2( 0x37);
	LCD_DataWrite_ST7789H2( 0x11);
	LCD_DataWrite_ST7789H2( 0x11);
	LCD_DataWrite_ST7789H2( 0x2f);
	LCD_DataWrite_ST7789H2( 0x34);
	LCD_CtrlWrite_ST7789H2( 0xe1);
	LCD_DataWrite_ST7789H2( 0xd0);
	LCD_DataWrite_ST7789H2( 0x27);
	LCD_DataWrite_ST7789H2( 0x2b);
	LCD_DataWrite_ST7789H2( 0x07);
	LCD_DataWrite_ST7789H2( 0x08);
	LCD_DataWrite_ST7789H2( 0x05);
	LCD_DataWrite_ST7789H2( 0x44);
	LCD_DataWrite_ST7789H2( 0x33);
	LCD_DataWrite_ST7789H2( 0x56);
	LCD_DataWrite_ST7789H2( 0x09);
...
#if !defined(MTK_BLE_SUPPORT)
    LCD_CtrlWrite_ST7789H2(0x2B);
    LCD_DataWrite_ST7789H2(((starty+80)&0xFF00)>>8);
    LCD_DataWrite_ST7789H2((starty+80)&0xFF);
    LCD_DataWrite_ST7789H2(((endy+80)&0xFF00)>>8);
    LCD_DataWrite_ST7789H2((endy+80)&0xFF);
#else
	LCD_CtrlWrite_ST7789H2(0x2B);
