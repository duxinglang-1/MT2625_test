...
#define GPIO_MT6381_AFE_PWD_PIN     BSP_BIO_SENSOR_AFE_PWD_PIN
#define GPIO_MT6381_RST_PORT_PIN    BSP_BIO_SENSOR_RST_PORT_PIN
#define GPIO_MT6381_32K             BSP_BIO_SENSOR_32K
...
uint32_t vsm_platform_get_us_tick();
