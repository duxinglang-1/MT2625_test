...
#define  TRNG_STOP_MASK              (0x0UL<< TRNG_STOP_OFFSET)
...
#define  TRNG_TIMEOUT_MASK               (0x1UL<< TRNG_RDY_OFFSET)
...
#define  TRNG_H_GARO2_EN_MASK       (0x1UL<< TRNG_H_GARO2_OFFSET)

#define  TRNG_H_GARO3_OFFSET        (12)
#define  TRNG_H_GARO3_EN_MASK       (0x1UL<< TRNG_H_GARO3_OFFSET)

#define  TRNG_H_GARO4_OFFSET        (13)
#define  TRNG_H_GARO4_EN_MASK       (0x1UL<< TRNG_H_GARO4_OFFSET)

#define  TRNG_H_GARO5_OFFSET        (14)
#define  TRNG_H_GARO5_EN_MASK       (0x1UL<< TRNG_H_GARO5_OFFSET)
