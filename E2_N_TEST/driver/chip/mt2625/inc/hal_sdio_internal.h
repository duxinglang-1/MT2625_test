...
#define COMMAND_R5_RESPONSE         0x0280  // now in DE spec, R5 & R6 the same as R1. So actually we have to set it as 0x0080, but de said they use else to deal with it. in the else function it will set 0x0080
#define COMMAND_R6_RESPONSE         0x0300  // now in DE spec, R5 & R6 the same as R1. So actually we have to set it as 0x0080, but de said they use else to deal with it. in the else function it will set 0x0080
