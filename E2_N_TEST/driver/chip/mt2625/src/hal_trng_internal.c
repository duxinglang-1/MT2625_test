...
//#define TRNG_DUMP_REGISTER
#ifdef TRNG_DUMP_REGISTER
uint32_t g_trng_reg[6];
#endif
...
#ifdef TRNG_DUMP_REGISTER
    g_trng_reg[0] = trng->TRNG_CTRL;
    g_trng_reg[2] = trng->TRNG_DATA;
#endif
}
...
#ifdef TRNG_DUMP_REGISTER
    g_trng_reg[4] = trng->TRNG_INT_SET;
#endif
