...
void hal_usbphy_poweron_initialize(void)
{
    ...
    USB_DRV_SetBits32(&musb_phy->u1phycr0, U1PHYCR0_RG_USB11_RST);
    USB_DRV_ClearBits32(&musb_phy->u1phycr0, U1PHYCR0_RG_USB11_RST);	
}
...
void hal_usbphy_save_current(void)
{
    ...
    //@@@@@@@@@@@
#else
	USB_DRV_ClearBits32(&musb_phy->u1phycr1, U1PHYCR1_RG_USB11_PHY_REV_7);	
	USB_DRV_ClearBits32(&musb_phy->u1phycr0, U1PHYCR0_RG_USB11_FSLS_ENBGRI);		
	USB_DRV_SetBits32(&musb_phy->u1phycr1, (3<<17)); // save current
...
void hal_usbphy_recover(void)
{
	...
	USB_DRV_ClearBits32(&musb_phy->u1phycr1, (3<<17)); // recover current
	USB_DRV_SetBits32(&musb_phy->u1phycr0, U1PHYCR0_RG_USB_LVSH_EN); // 2625 new added.
	USB_DRV_ClearBits32(&musb_phy->u1phycr1, U1PHYCR1_RG_USB11_PHY_REV_7);
	USB_DRV_SetBits32(&musb_phy->u1phycr0, U1PHYCR0_RG_USB11_FSLS_ENBGRI);	
