...
void spi_slave_lisr(hal_spi_slave_port_t spi_port, hal_spi_slave_callback_t user_callback, void *user_data)
{
    ...
    switch (irq_status) {
        case SPIS_INT_POWER_ON_MASK:
            ...
            hal_sleep_manager_acquire_sleeplock(SLEEP_LOCK_SPI_SLAVE, HAL_SLEEP_LOCK_ALL);
#endif
        ...
        case SPIS_INT_POWER_OFF_MASK:
            ...
            hal_sleep_manager_release_sleeplock(SLEEP_LOCK_SPI_SLAVE, HAL_SLEEP_LOCK_ALL);
#endif
            break;
