...
GDMA_REGISTER_GLOBAL_T  *gdma_global[GDMA_NUMBER] = {GDMA_GLOAL1,GDMA_GLOAL1,GDMA_GLOAL2};
...
#ifdef HAL_SLEEP_MANAGER_ENABLED
uint8_t g_gdma_sleep_handle[GDMA_NUMBER] = {SLEEP_LOCK_INVALID_ID, SLEEP_LOCK_INVALID_ID, SLEEP_LOCK_INVALID_ID};
bool g_gdma_sleep_lock_status[GDMA_NUMBER] = {false, false, false};
char* g_gdma_sleep_handle_name[GDMA_NUMBER] = {"GDMA0", "GDMA1", "SENSOR_GDMA"};
#endif
...
#ifdef HAL_SLEEP_MANAGER_ENABLED
 if(g_gdma_sleep_handle[channel] == SLEEP_LOCK_INVALID_ID)
 {
     g_gdma_sleep_handle[channel] = hal_sleep_manager_set_sleep_handle(g_gdma_sleep_handle_name[channel]);
     g_gdma_sleep_lock_status[channel] = false;
 }
#endif
}
