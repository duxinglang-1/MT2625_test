...
PWM_REGISTER_T  *pwm[PWM_NUMBER] = {PWM0, PWM1, PWM2, PWM3};

static bool pwm_run_status[PWM_NUMBER] = {false, false, false, false};

const hal_clock_cg_id pwm_pdn[PWM_NUMBER] = {HAL_CLOCK_CG_PWM0, HAL_CLOCK_CG_PWM1, HAL_CLOCK_CG_PWM2, HAL_CLOCK_CG_PWM3};
