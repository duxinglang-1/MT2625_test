...
hal_spi_slave_status_t hal_spi_slave_init(hal_spi_slave_port_t spi_port, hal_spi_slave_config_t *spi_configure)
{
    ...
    sleep_management_register_suspend_callback(SLEEP_BACKUP_RESTORE_SPI_SLAVE, (sleep_management_suspend_callback_t)spi_slave_backup_register_callback, NULL, HAL_SLEEP_MODE_LIGHT_SLEEP|HAL_SLEEP_MODE_DEEP_SLEEP|HAL_SLEEP_MODE_DEEPER_SLEEP);
    sleep_management_register_resume_callback(SLEEP_BACKUP_RESTORE_SPI_SLAVE, (sleep_management_resume_callback_t)spi_slave_restore_register_callback, NULL, HAL_SLEEP_MODE_LIGHT_SLEEP|HAL_SLEEP_MODE_DEEP_SLEEP|HAL_SLEEP_MODE_DEEPER_SLEEP);
#endif
...
hal_spi_slave_status_t hal_spi_slave_deinit(hal_spi_slave_port_t spi_port)
{
    ...
    NVIC_DisableIRQ(g_spi_slave_irq_code[spi_port]);
        ...
        void *user_data)
{
    ...
    NVIC_SetPriority(g_spi_slave_irq_code[spi_port], g_spi_slave_pri_code[spi_port]);
    NVIC_EnableIRQ(g_spi_slave_irq_code[spi_port]);
