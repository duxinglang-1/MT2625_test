...
/** @brief This enum defines the hardware key type.
  */
typedef enum {
    HAL_AES_EFUSE_KEY1 = 0,        /**< EFUSE key1 */
    HAL_AES_EFUSE_KEY2 = 1,        /**< EFUSE key2 */
    HAL_AES_HW_CKDF_KEY1 = 2,      /**< CKDF key1 */
    HAL_AES_HW_CKDF_KEY2 = 3,      /**< CKDF key2 */
} hal_aes_key_t;
 ...
 * @param[in]  init_vector is the AES initialzation vector for encryption.
 * @param[in]  key_index is the index to specify which kind of key is used.
