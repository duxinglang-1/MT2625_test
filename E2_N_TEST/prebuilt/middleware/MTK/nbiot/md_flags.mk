...
#for Macro define for BC66 NA qorvo
ifeq ($(MTK_BC66_NA_QORVO_ENABLE), y)
CFLAGS += -DMTK_BC66_NA_QORVO_ENABLE
#CFLAGS += -DNBIOT_THERM_REF_POWER_VIO18
endif
...
#Enable CMUX UIH frame CR PF bit check
#CFLAGS += -DFEA_CMUX_DLC_FC_XON_XOFF

#Enable CMUX all mandatory 27010 control messages
#CFLAGS += -DFEA_CMUX_ALL_CTRL_MSG
...
ifeq ($(MTK_NBIOT_ICD_ENABLE), y)
    CFLAGS += -DMTK_NBIOT_ICD_ENABLE
    CFLAGS += $(foreach subdir, $(shell find $(SOURCE_DIR)/$(NBIOT_SRC)/modem/icd -maxdepth 2 -type d),-I$(subdir))
endif

#Enable RoHC feature for Operator RJIO 
ifeq ($(MTK_NBIOT_ROHC_ENABLE), y)
    # FEA_CP_ROHC: Enabling of Control Plane ROHC on ESM/EMM
    CFLAGS += -DFEA_CP_ROHC
    # FEA_UP_ROHC: Enabling of User Plane ROHC on PDCP
    CFLAGS += -DFEA_UP_ROHC
endif
