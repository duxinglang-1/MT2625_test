...
static inline coap_queue_t *
coap_malloc_node() {
	return (coap_queue_t *)mem_malloc(sizeof(coap_queue_t));
}
...
#endif /* WITH_POSIX */
#ifdef WITH_LWIP
  coap_context_t *c = (coap_context_t *)mem_malloc(sizeof(coap_context_t));
#endif /* WITH_LWIP */
#ifdef WITH_CONTIKI
  coap_context_t *c;
...
#ifdef WITH_POSIX
ATTR_NONINIT_DATA_IN_RAM static char buf[COAP_MAX_PDU_SIZE];
#endif
#if defined(WITH_LWIP) || defined(WITH_CONTIKI)
  char *buf;
#endif
