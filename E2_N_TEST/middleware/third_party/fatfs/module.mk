...
C_FILES += 	$(FATFS_SRC)/src/portable/mt2625/src/diskio.c
C_FILES += 	$(FATFS_SRC)/src/portable/mt2625/src/diskio_sd.c
C_FILES += 	$(FATFS_SRC)/src/portable/mt2625/src/diskio_snor.c
endif
...
ifeq ($(PRODUCT_VERSION),2625)
CFLAGS  += -I$(SOURCE_DIR)/$(FATFS_SRC)/src/portable/mt2625/inc
endif
