...
static void handle_12345(lwm2m_block1_data_t ** blk1,
    ...
    coap_status_t st = lwm2m_block1_handler(blk1, mid, buffer, 5, 5, 0, true, &resultBuffer, &bsize);
...
static void handle_67(lwm2m_block1_data_t ** blk1,
    ...
    coap_status_t st = lwm2m_block1_handler(blk1, mid, buffer, 2, 5, 1, false, &resultBuffer, &bsize);
    CU_ASSERT_EQUAL(st, COAP_NO_ERROR);
