...
static void test_uri_decode(void)
{
    ...
    /* "/bs" */
    uri = lwm2m_uri_decode(NULL, &boot);
    CU_ASSERT_PTR_NOT_NULL_FATAL(uri);
...
static struct TestTable table[] = {
        { "test of lwm2m_uri_decode()", test_uri_decode },
