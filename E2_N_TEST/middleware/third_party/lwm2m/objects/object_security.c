...
static uint8_t prv_security_write(void * contextP,
                                  uint16_t instanceId,
                                  int numData,
                                  ...
                                  lwm2m_object_t * objectP)
{
    ...
    LOG_ARG("prv_security_write instanceId:%d", instanceId);
...
static uint8_t prv_security_create(void * contextP,
                                   uint16_t instanceId,
                                   int numData,
                                   lwm2m_data_t * dataArray,
                                   lwm2m_object_t * objectP)
{
    ...
    LOG_ARG("prv_security_create instanceId:%d", instanceId);
    ...
    result = prv_security_write(contextP, instanceId, numData, dataArray, objectP);
