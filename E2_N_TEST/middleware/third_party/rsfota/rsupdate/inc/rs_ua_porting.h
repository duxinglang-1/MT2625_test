...
// TODO: 配置升级包区域的起始地址
#define RS_UA_DELTA_ADDR				(FOTA_RESERVED_BASE - 0x08000000)

#else

// TODO: 配置升级包、信息文件、GPS文件所在路径
#define RS_UA_UPDATEINFO1_FILE			"C:\\updateinfo1"
#define RS_UA_UPDATEINFO2_FILE			"C:\\updateinfo2"
#define RS_UA_DELTA_FILE				"C:\\update.bin"
#define RS_UA_EXTEND_FILE				"C:\\GPS.bin"
...
// TODO: 配置Flash的block的大小
#define RS_FOTA_UA_FLASH_BLCOK_SIZE		0x1000//BLOCK_SIZE

// TODO: 配置存放updateinfo的block的大小
#define RS_FOTA_UA_UPDATEINFO_BLCOK_SIZE		(2*0x1000)//BLOCK_SIZE
...
DELTA_DATA_TYPE rs_ua_getUnitDataType(rs_u32 index);
