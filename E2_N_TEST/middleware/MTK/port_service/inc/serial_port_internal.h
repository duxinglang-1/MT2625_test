...
serial_port_status_t serial_port_fake_control(serial_port_dev_t device, serial_port_ctrl_cmd_t cmd, serial_port_ctrl_para_t *para);
serial_port_status_t serial_port_fake_deinit(serial_port_dev_t device);
