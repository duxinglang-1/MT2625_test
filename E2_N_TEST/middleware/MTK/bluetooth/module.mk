...
else ifeq ($(IC_CONFIG), mt2625)
LIBS += $(SOURCE_DIR)/prebuilt/middleware/MTK/bluetooth/lib/libbtdriver_2625_release.a
endif
...
LIBS += $(SOURCE_DIR)/prebuilt/middleware/MTK/bluetooth/lib/libbtdriver_2625.a
endif
