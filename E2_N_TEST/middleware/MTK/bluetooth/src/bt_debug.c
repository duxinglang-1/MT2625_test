...
#define BT_DEBUG_ADDR_BUFF_SIZE  40
static char bt_debug_buff[BT_DEBUG_BUFF_SIZE];
static char bt_debug_addr_buff[BT_DEBUG_ADDR_BUFF_SIZE];
...
{
    snprintf(bt_debug_addr_buff, BT_DEBUG_ADDR_BUFF_SIZE, "%02x-%02x-%02x-%02x-%02x-%02x",
            addr[5], addr[4], addr[3], addr[2], addr[1], addr[0]);
    return bt_debug_addr_buff;
}

const char *bt_debug_bd_addr2str2(const bt_bd_addr_t addr)
{
    snprintf(bt_debug_addr_buff, BT_DEBUG_ADDR_BUFF_SIZE, "LAP: %02x-%02x-%02x, UAP: %02x, NAP: %02x-%02x",
...
const char *bt_debug_addr2str(const bt_addr_t *p)
{
    ...
    snprintf(bt_debug_addr_buff, BT_DEBUG_ADDR_BUFF_SIZE, "[%s%s] %02x-%02x-%02x-%02x-%02x-%02x",
...
{
    bt_bd_addr_ptr_t addr = p->addr;
    snprintf(bt_debug_addr_buff, BT_DEBUG_ADDR_BUFF_SIZE, "[%s%s] LAP: %02x-%02x-%02x, UAP: %02x, NAP: %02x-%02x",
            (p->type & 0x01) == BT_ADDR_PUBLIC ? "PUBLIC" : "RANDOM",
             p->type >=2 ?"_IDENTITY":"",
            addr[2], addr[1], addr[0], addr[3], addr[5], addr[4]);
    return bt_debug_addr_buff;
