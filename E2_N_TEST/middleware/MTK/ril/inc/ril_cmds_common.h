...
extern ril_status_t ril_request_send_via_channel_prior(
    ril_request_mode_t mode,
    ril_cmd_id_t cmd_id,
    ril_param_node_t * param,
    void * callback,
...
extern const char *active_mode_format;
extern const char *read_mode_format;
extern const char *test_mode_format;
