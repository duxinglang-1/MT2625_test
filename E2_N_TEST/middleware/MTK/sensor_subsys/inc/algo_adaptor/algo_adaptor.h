...
#define SENSIO_NVDM_GROUP_NAME "sensio"
#define SENSIO_NVDM_HM_INFO_NAME "hm_info"
#define NVRAM_EF_HM_USERID_LEN 20
...
typedef struct {
    ...
    uint32_t weight;
    uint32_t gender;
    char userid[NVRAM_EF_HM_USERID_LEN + 1];
    uint32_t bp_mode;
    int32_t analogGain;
    int32_t analogOffset;
    int32_t calibrate_para[7];
} sensio_nvdm_hm_info_struct;
