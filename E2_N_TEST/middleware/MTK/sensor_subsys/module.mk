...
SENSOR_SUBSYS_FILES += $(SENSOR_SUBSYS_SRC)/src/ring_buffer.c
...
SENSOR_FUSION_ALGO_ADAPTOR_FILES += $(SENSOR_SUBSYS_SRC)/src/algo_adaptor/sensio_adaptor.c
  ifneq ($(wildcard $(SOURCE_DIR)/prebuilt/middleware/MTK/fusion_algo/biosensor/lib/lib_bsp_CM4_GCC.a),)
    LIBS += $(SOURCE_DIR)/prebuilt/middleware/MTK/fusion_algo/biosensor/lib/lib_bsp_CM4_GCC.a
  endif
CFLAGS += -I$(SOURCE_DIR)/prebuilt/middleware/MTK/fusion_algo/biosensor/inc
endif
