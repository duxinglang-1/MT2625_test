...
#ifndef APB_PROXY_CHANNEL_ID_OFFSET
#define APB_PROXY_CHANNEL_ID_OFFSET  8U
#endif
...
#endif
/***************************************************************************
 * \section APBRIDGE_DataModeClosedInd
 *
 *    \code
 *
 *           0                   1                   2                   3
 ...
 * - Channel ID – Identifier of the channel in case of multi-channel support.
 ***************************************************************************/
 #ifndef APB_PROXY_DATA_MODE_CLOSED_IND_PACKET_SIZE
 #define APB_PROXY_DATA_MODE_CLOSED_IND_PACKET_SIZE ( APB_PROXY_MSG_TYPE_FIELD_SIZE  \
                                                     + APB_PROXY_MSG_LENGTH_FIELD_SIZE \
                                                     + APB_PROXY_CHANNEL_ID_FIELD_SIZE )
 #endif

 #ifndef APB_PROXY_DATA_MODE_CLOSED_IND_CHANNEL_ID_OFFSET
 #define APB_PROXY_DATA_MODE_CLOSED_IND_CHANNEL_ID_OFFSET (APB_PROXY_MSG_TYPE_FIELD_SIZE + APB_PROXY_MSG_LENGTH_FIELD_SIZE)
 #endif

 /***************************************************************************
  * \section APBRIDGE_DataModeTempDeactivated
  *
  *    \code
  *
  *           0                   1                   2                   3
  ...
  * - Channel ID – Identifier of the channel in case of multi-channel support.
  ***************************************************************************/
 #ifndef APB_PROXY_DATA_MODE_TEMP_DEACTIVE_IND_PACKET_SIZE
 #define APB_PROXY_DATA_MODE_TEMP_DEACTIVE_IND_PACKET_SIZE ( APB_PROXY_MSG_TYPE_FIELD_SIZE  \
                                                           + APB_PROXY_MSG_LENGTH_FIELD_SIZE \
                                                           + APB_PROXY_CHANNEL_ID_FIELD_SIZE )
 #endif

 #ifndef APB_PROXY_DATA_MODE_TEMP_DEACTIVE_IND_CHANNEL_ID_OFFSET
 #define APB_PROXY_DATA_MODE_TEMP_DEACTIVE_IND_CHANNEL_ID_OFFSET (APB_PROXY_MSG_TYPE_FIELD_SIZE + APB_PROXY_MSG_LENGTH_FIELD_SIZE)
 #endif

 /***************************************************************************
  * \section APBRIDGE_DataModeResumeReq
  *
  *    \code
  *
  *           0                   1                   2                   3
  ...
  * - Channel ID – Identifier of the channel in case of multi-channel support.
  ***************************************************************************/
#ifndef APB_PROXY_DATA_MODE_RESUME_REQ_PACKET_SIZE
#define APB_PROXY_DATA_MODE_RESUME_REQ_PACKET_SIZE ( APB_PROXY_MSG_TYPE_FIELD_SIZE  \
                                                   + APB_PROXY_MSG_LENGTH_FIELD_SIZE \
                                                   + APB_PROXY_CHANNEL_ID_FIELD_SIZE )
#endif

#ifndef APB_PROXY_DATA_MODE_RESUME_REQ_CHANNEL_ID_OFFSET
#define APB_PROXY_DATA_MODE_RESUME_REQ_CHANNEL_ID_OFFSET (APB_PROXY_MSG_TYPE_FIELD_SIZE + APB_PROXY_MSG_LENGTH_FIELD_SIZE)
#endif

 /***************************************************************************
  * \section APBRIDGE_DataModeCloseReq
  *
  *    \code
  *
  *           0                   1                   2                   3
  ...
  * - Channel ID – Identifier of the channel in case of multi-channel support.
  ***************************************************************************/
#ifndef APB_PROXY_DATA_MODE_CLOSE_REQ_PACKET_SIZE
#define APB_PROXY_DATA_MODE_CLOSE_REQ_PACKET_SIZE ( APB_PROXY_MSG_TYPE_FIELD_SIZE  \
                                                  + APB_PROXY_MSG_LENGTH_FIELD_SIZE \
                                                  + APB_PROXY_CHANNEL_ID_FIELD_SIZE )
#endif

#ifndef APB_PROXY_DATA_MODE_CLOSE_REQ_CHANNEL_ID_OFFSET
#define APB_PROXY_DATA_MODE_CLOSE_REQ_CHANNEL_ID_OFFSET (APB_PROXY_MSG_TYPE_FIELD_SIZE + APB_PROXY_MSG_LENGTH_FIELD_SIZE)
#endif

 /***************************************************************************
  * \section APBRIDGE_DataModeResumedInd
  *
  *    \code
  *
  *           0                   1                   2                   3
  ...
  * - Channel ID – Identifier of the channel in case of multi-channel support.
  ***************************************************************************/
#ifndef APB_PROXY_DATA_MODE_RESUMED_IND_PACKET_SIZE
#define APB_PROXY_DATA_MODE_RESUMED_IND_PACKET_SIZE ( APB_PROXY_MSG_TYPE_FIELD_SIZE  \
                                                    + APB_PROXY_MSG_LENGTH_FIELD_SIZE \
                                                    + APB_PROXY_CHANNEL_ID_FIELD_SIZE )
#endif

#ifndef APB_PROXY_DATA_MODE_RESUMED_IND_CHANNEL_ID_OFFSET
#define APB_PROXY_DATA_MODE_RESUMED_IND_CHANNEL_ID_OFFSET (APB_PROXY_MSG_TYPE_FIELD_SIZE + APB_PROXY_MSG_LENGTH_FIELD_SIZE)
#endif
...
#define APBRIDGE_CODE_DATA_MODE_CLOSED_IND         (9)      /**< Data mode closed indication (sent from MD to AP) */
#define APBRIDGE_CODE_DATA_MODE_TEMP_DEACTIVE_IND  (10)     /**< Data mode temporally deactived indication (sent from MD to AP) */
#define APBRIDGE_CODE_DATA_MODE_RESUME_REQ         (11)     /**< Resume the data mode (sent from AP to MD) */
#define APBRIDGE_CODE_DATA_MODE_CLOSE_REQ          (12)     /**< Data mode close request (sent from AP to MD) */
#define APBRIDGE_CODE_DATA_MODE_RESUMED_IND        (13)     /**< Resumed the data mode indication(sent from MD to AP) */
/* Command ID field */
...
#define APBRIDGE_RESULT_CUSTOM_CONNECT      (11)    /**< The user fills hte customed response output when data connection sets up. */
#define APBRIDGE_RESULT_CUSTOM_ERROR        (12)    /**< Custom error final response */
