...
#else
#define LOGE(fmt,arg...)   printf("ATCMD: "fmt,##arg)
#define LOGW(fmt,arg...)   printf("ATCMD: "fmt,##arg)
#define LOGI(fmt,arg...)   printf("ATCMD: "fmt,##arg)
#endif
...
atci_cmd_hdlr_item_t atcmd_table[] = {
...
#if defined(MTK_NVDM_MODEM_ENABLE)
    {"AT+ENVDMMD", atci_cmd_hdlr_nvdm_modem, 0, 0},
#endif
    ...
    {"AT+EBTSHCD", atci_cmd_hdlr_bt_send_hci_command_to_host, 0, 0},
    ...
    {"AT+EUSIMSMT",     atci_cmd_hdlr_usimsmt,         0, 0},
#endif
