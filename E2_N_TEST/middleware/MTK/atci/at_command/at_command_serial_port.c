...
#ifdef MTK_BT_ENABLED
extern void hci_serial_port_switch(serial_port_dev_t device);
#endif
...
atci_status_t atci_cmd_hdlr_serial_port(atci_parse_cmd_param_t *parse_cmd)
{
    ...
    switch (parse_cmd->mode) {
        case ATCI_CMD_MODE_TESTING:
            ...
            strcpy((char *)(response.response_buf), AT_COMMAND_SERIAL_PORT_HELP);
