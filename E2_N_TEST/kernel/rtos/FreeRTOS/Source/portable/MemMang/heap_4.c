...
/* heap debug control for heap corruption/full check */
#define MTK_SUPPORT_HEAP_DEBUG
#define MAGIC_HEAP_OVERHEADER 0xFEDCBA98
...
#ifdef MTK_SUPPORT_HEAP_DEBUG
        xStart.magic_header = MAGIC_HEAP_OVERHEADER;
#endif
...
#ifdef MTK_SUPPORT_HEAP_DEBUG
    pxEnd->magic_header = MAGIC_HEAP_OVERHEADER;
#endif
...
#ifdef MTK_SUPPORT_HEAP_DEBUG
    pxFirstFreeBlock->magic_header = MAGIC_HEAP_OVERHEADER;
#endif
	#if defined(MTK_SUPPORT_HEAP_DEBUG) || defined(MTK_HEAP_SIZE_GUARD_ENABLE)
...
void *pvPortCalloc( size_t nmemb, size_t size )
{
    ...
    if (pvReturn)
    {
        ...
        BlockLink_t *pxLink = (BlockLink_t *)( (uint32_t)pvReturn - xHeapStructSize );
