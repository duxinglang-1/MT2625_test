...
extern unsigned int Image$$MD_RETSRAM_DATA$$ZI$$Limit[];
extern unsigned int Image$$RETSRAM_DATA$$RW$$Base[];
extern unsigned int Image$$RETSRAM_DATA$$ZI$$Limit[];


#ifdef MTK_NBIOT_TARGET_BUILD
extern unsigned int Image$$GKI_STACK$$Base[];
extern unsigned int Image$$GKI_STACK$$Limit[];
...
const memory_region_type memory_regions[] =
{
...
#ifdef MTK_NBIOT_TARGET_BUILD
    {"gki_stack", Image$$GKI_STACK$$Base, Image$$GKI_STACK$$Limit, 1},
#endif /*MTK_NBIOT_TARGET_BUILD*/
    ...
    {"md_retsram", Image$$MD_RETSRAM_DATA$$RW$$Base, Image$$MD_RETSRAM_DATA$$ZI$$Limit, 1},
    {"retsram_data", Image$$RETSRAM_DATA$$RW$$Base, Image$$RETSRAM_DATA$$ZI$$Limit, 1},
    {"stack", Image$$TCM$$ZI$$Limit, Image$$STACK$$ZI$$Limit, 1},
    {"rtc_reg", 0xA2080000, 0xA20800A0, 1},
    {"UART0", 0xA00C0000, 0xA00C0100, 1},
    {"UART1", 0xA00D0000, 0xA00D0100, 1},
    {"UART2", 0xA00E0000, 0xA00E0100, 1},
    {"UART3", 0xA00F0000, 0xA00F0100, 1},
