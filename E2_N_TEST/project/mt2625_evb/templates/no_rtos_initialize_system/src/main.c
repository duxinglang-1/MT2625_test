...
static void plain_log_uart_init(void)
{
    ...
    hal_pinmux_set_function(HAL_GPIO_5, HAL_GPIO_5_UART0_TXD);
    hal_pinmux_set_function(HAL_GPIO_2, HAL_GPIO_2_UART0_RXD);
...
int main(void)
{
    ...
    printf("system initialize done@%u.\r\n", (unsigned int)hal_dvfs_get_cpu_frequency());
