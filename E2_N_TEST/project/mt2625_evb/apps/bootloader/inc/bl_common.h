...
#ifndef BL_FOTA_SEC_HEADER_LEN
#define BL_FOTA_SEC_HEADER_LEN 4096 /*The unit is bytes.*/
#endif

typedef enum {
    BL_SEC_DISABLED = 0,/*The security feature is disabled.*/
    BL_SEC_ENABLED  = 1 /*The security feature is enabled.*/
} bl_sec_status_t;
