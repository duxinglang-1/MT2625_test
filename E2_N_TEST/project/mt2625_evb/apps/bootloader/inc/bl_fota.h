...
#define BL_FOTA_BIN_NUMBER_MAX                     4

#define BL_FOTA_MAIN_BIN_TYPE_VALUE                1
#define BL_FOTA_MAIN_BIN_SEC_HEADER_TYPE_VALUE     2
#define BL_FOTA_GNSS_BIN_TYPE_VALUE                3
